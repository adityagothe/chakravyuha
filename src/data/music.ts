...
export const songs = [
  {
    ...
    links: {
      ...
      appleMusic: null,
      youtube: 'https://youtube.com/@victor5400_parasf',
      youtubeMusic: null,
    },
  },
  {
    id: '02',
    title: 'HEART ON DUTY',
    tagline: 'A rhythmic exploration of discipline and unwavering focus.',
    description:
      'Inspired by the Habitropolis philosophy, this song evokes the feeling of construction — the steady, relentless movement that separates those who build from those who only dream.',
    coverImage: null,
    links: {
      spotify: 'https://open.spotify.com/artist/7y9XCzNr4SgPxSV4cGt3kz',
      appleMusic: null,
