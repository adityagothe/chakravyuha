...
export const vittora: Project = {
  ...
  downloads: {
    apkUrl: 'https://github.com/adityagothe/chakravyuha/releases/download/v2.0.1/Vittora.apk',
    githubReleaseUrl: 'https://github.com/adityagothe/chakravyuha/releases/tag/v2.0.1',
    sourceCodeUrl: 'https://github.com/adityagothe/chakravyuha',
    version: '2.0.1',
    versionCode: 2,
    releaseDate: '2026-04-04T00:00:00Z',
    releaseNotes: '• v2.0.1 — The Motivation & Clarity Update\n• Universal Motivation Engine & Intelligent Push Notifications\n• Refined Dashboard Experience & Critical Stability Fixes',
    fileSize: '~100 MB',
