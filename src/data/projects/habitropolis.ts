...
export const habitropolis: Project = {
  ...
  downloads: {
    apkUrl: 'https://github.com/adityagothe/habitropolis/releases/download/v1.2.0/habitropolis-v1.2.0.apk',
    githubReleaseUrl: 'https://github.com/adityagothe/habitropolis/releases/tag/v1.2.0',
    sourceCodeUrl: 'https://github.com/adityagothe/habitropolis',
    version: '1.2.0',
    versionCode: 12,
